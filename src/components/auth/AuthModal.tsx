...
import {
  ...
  CheckCircle2, Send, KeyRound, Building2, MapPin, FileText, Crown,
} from 'lucide-react';
...
export default function AuthModal({ isOpen, onClose }: AuthModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-gray-200/80 p-4" onClick={handleClose}>
      <div
      ...
      >
        ...
        {!forgotPasswordMode && (
          <>
            <button
              type="button"
              className="w-full flex items-center justify-center gap-3 rounded-xl border border-gray-300 bg-white px-4 py-3 text-sm font-semibold text-gray-700 hover:bg-gray-50 transition-colors shadow-sm"
            >
            ...
            <div className="relative my-5">
              ...
              <div className="relative flex justify-center"><span className="bg-gray-200 px-4 text-sm text-gray-500">oppure</span></div>
            </div>
          </>
        )}

        {/* ── Form card ── */}
        <form onSubmit={handleSubmit} className="rounded-2xl bg-white shadow-lg p-6 space-y-4 max-h-[65vh] overflow-y-auto">
          ...
          {mode === 'register' && !forgotPasswordMode && (
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <User className={`mb-1 h-5 w-5 ${role === 'client' ? 'text-teal-600' : 'text-gray-400'}`} />
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-gray-300 py-2.5 pl-10 pr-3 text-sm focus:border-teal-500 focus:ring-2 focus:ring-teal-200 focus:outline-none transition-colors"
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-xl border border-gray-300 py-2.5 px-4 text-sm focus:border-teal-500 focus:ring-2 focus:ring-teal-200 focus:outline-none transition-colors"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-xl border border-gray-300 py-2.5 px-4 pr-10 text-sm focus:border-teal-500 focus:ring-2 focus:ring-teal-200 focus:outline-none transition-colors"
          ...
          {forgotPasswordMode ? (
            <div className="space-y-3 pt-2">
              <button
                ...
                className="w-full rounded-xl bg-teal-700 py-3 text-sm font-bold text-white hover:bg-teal-800 transition-colors"
              >
            ...
            <div className="space-y-3 pt-1">
              <button
                ...
                className="w-full rounded-xl bg-teal-700 py-3 text-sm font-bold text-white hover:bg-teal-800 disabled:opacity-60 transition-colors"
              >
                {actionLabel}
              </button>
              {mode === 'login' && (
