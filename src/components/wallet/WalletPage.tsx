...
export default function WalletPage() {
  ...
  const getStatusBadge = (status: WalletTransaction['status']) => {
    switch (status) {
      case 'completed': return <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-bold bg-green-100 text-green-700"><CheckCircle className="w-3 h-3" /> Completato</span>;
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
          ...
          <div className="bg-green-50 border border-green-200 rounded-xl p-4 mb-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-green-700">Saldo disponibile</p>
                <p className="text-2xl font-black text-green-800">{user.walletBalance.toFixed(2)}</p>
              </div>
